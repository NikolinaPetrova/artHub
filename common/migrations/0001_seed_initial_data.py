# Generated by Django 6.0.1 on 2026-03-11 17:52
...
def get_models(apps):
    ...
    return ArtHubUser, Profile, Album, Artwork, Tag, Comment, Like


def seed_data(apps, schema_editor):
    ArtHubUser, Profile, Album, Artwork, Tag, Comment, Like = get_models(apps)
    ...
    Profile.objects.create(user=alice, professional_artist=True)
    ...
    Profile.objects.create(user=dave)
    ...
    alice_default_album = Album.objects.create(name='Default Album', owner=alice)
    mountain_diaries = Album.objects.create(name='Mountain Diaries', owner=alice)
    dave_default_album = Album.objects.create(name='Default Album', owner=dave)
    digital = Album.objects.create(name='Digital Album', owner=dave)
